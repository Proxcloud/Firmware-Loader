...
//---------------------------------------------
supportedDevices.put(Integer.valueOf(UsbId.ven_pm3), new int[]{	UsbId.pm3,});
supportedDevices.put(Integer.valueOf(UsbId.ven_pm32), new int[]{ UsbId.pm32,});
supportedDevices.put(Integer.valueOf(UsbId.ven_pm33), new int[]{ UsbId.pm33,});
